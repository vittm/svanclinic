@extends('layout')
@section('title')
    <title>Bảng giá Svan Clinic & Spa - Giảm béo và trị liệu da hàng đầu Việt Nam</title>
@stop
            ...
            <div class="row">
                <div class="col-xs-12">
                    <div class="price-list-container">
                        <div class="panel-group" id="price-list-tab" role="tablist" aria-multiselectable="true">
                            <div class="panel-header">
                                ...
                                <div class="big-circle"></div>
                                 ...
                                 <div class="panel panel-default panel-price">
                                    ...
                                    <div id="tab1" class="panel-collapse collapse" role="tabpanel">
...
<p>&nbsp;</p>
                                 ...
                                 <div class="panel panel-default panel-price">
                                    ...
                                    <div id="tab2" class="panel-collapse collapse" role="tabpanel">
                                        <div class="panel-body">
                                            <table>
	<tbody>
		<tr>
		...
		<tr>
			...
			<td style="text-align: right;">300.000/cm2</td>
                                 ...
                                 <div class="panel panel-default panel-price">
                                    <div class="panel-heading" role="tab">
                                        <h4 class="panel-title">
                                            <a role="button" class="panel-btn" data-toggle="collapse" data-parent="#price-list-tab" href="#tab23" aria-expanded="true">
                                                <span>TRỊ LIỆU DA MẶT</span>
                                            </a>
                                        </h4>
                                    </div>
                                    <div id="tab23" class="panel-collapse collapse" role="tabpanel">
                                        <div class="panel-body">
                                            <table>
	<tbody>
		<tr>
		...
		<tr>
			<td><span style="color:#3d9c74;"><strong>DỊCH VỤ TRỊ MỤN</strong></span></td>
			<td>&nbsp;</td>
			<td>&nbsp;</td>
		</tr>
		<tr>
		...
		<tr>
			<td><span style="color:#3d9c74;"><strong>DỊCH VỤ DƯỠNG DA MẶT CƠ BẢN</strong></span></td>
			<td>&nbsp;</td>
			<td>&nbsp;</td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td>650.000</td>
                                 ...
                                 <div class="panel panel-default panel-price">
                                    ...
                                    <div id="tab27" class="panel-collapse collapse" role="tabpanel">
                                        <div class="panel-body">
                                            <table>
	<tbody>
		<tr>
...
<p>&nbsp;</p>
                                 ...
                                 <div class="panel panel-default panel-price">
                                    ...
                                    <div id="tab24" class="panel-collapse collapse" role="tabpanel">
                                        <div class="panel-body">
                                            <table>
	<tbody>
		<tr>
